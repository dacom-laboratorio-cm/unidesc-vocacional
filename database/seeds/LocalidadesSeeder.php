...
class LocalidadesSeeder extends Seeder
{
    ...
    //         Estado::create(['sg_estado' => $chave, 'nm_estado' => $estado]);
    //     }
    ...
    //     ];
        ...
        // foreach ($localidades as $localizacao) {
        //     foreach ($localizacao['cidades'] as $cidade) {
        //         $estado_id = Estado::where('sg_estado', $localizacao['sigla'])->select('id')->first()->id;
        //         Cidade::create([
        //             'nm_cidade' => $cidade,
        //             'estado_id' => $estado_id
        //         ]);
        //         echo "$cidade - " .$localizacao['sigla']. " ID estado: $estado_id\n";
        //     }
        // }
